...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference("Experience.count") do
      post experiences_url, params: { experience: { description: @experience.description, end_date: @experience.end_date, start_date: @experience.start_date, title: @experience.title } }
    end
